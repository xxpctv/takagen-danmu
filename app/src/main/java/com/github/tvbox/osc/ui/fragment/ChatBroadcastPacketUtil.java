...
import com.github.tvbox.osc.danmu.InflateUtil;
...
public class ChatBroadcastPacketUtil {
    ...
    public static ByteBuffer encode(String content, int protocolVersion, int operation) throws UnsupportedEncodingException {
